...
```python id="88Qmb5nEPYq6" colab={"base_uri": "https://localhost:8080/"} executionInfo={"status": "ok", "timestamp": 1726487555448, "user_tz": -120, "elapsed": 23780, "user": {"displayName": "Mario Negrello", "userId": "10136788594790905986"}} outputId="345756b9-ed04-4aec-fcf2-0c545be96688"
# install brian2
...
```python id="a1QijtWiaKrZ" executionInfo={"status": "ok", "timestamp": 1726488182979, "user_tz": -120, "elapsed": 260, "user": {"displayName": "Mario Negrello", "userId": "10136788594790905986"}}
...
```python id="HVKItlSCkN3G" executionInfo={"status": "ok", "timestamp": 1726488186459, "user_tz": -120, "elapsed": 237, "user": {"displayName": "Mario Negrello", "userId": "10136788594790905986"}}
# SETUP
...
```python id="9EAd70fvtFPM" executionInfo={"status": "ok", "timestamp": 1726488282198, "user_tz": -120, "elapsed": 16120, "user": {"displayName": "Mario Negrello", "userId": "10136788594790905986"}}
...
```python colab={"base_uri": "https://localhost:8080/", "height": 740} id="B2Pfnc4YtJ9a" executionInfo={"status": "ok", "timestamp": 1726488359011, "user_tz": -120, "elapsed": 2148, "user": {"displayName": "Mario Negrello", "userId": "10136788594790905986"}} outputId="10b979d3-b81f-453d-a3bc-a634bc94f691"
...
```python id="PKmnK3QDesOd" colab={"base_uri": "https://localhost:8080/", "height": 407} executionInfo={"status": "ok", "timestamp": 1726488388235, "user_tz": -120, "elapsed": 2043, "user": {"displayName": "Mario Negrello", "userId": "10136788594790905986"}} outputId="32b7a619-7f71-49eb-dd31-d8eaf00d2ed0"
#Protocol 1
restore('setup')
G.v = 0*mV
G.m = 0
...
```python id="Z41H26kjsUOK"

```

<!-- #region id="uteh1KXslWu8" -->
#### Solution
<!-- #endregion -->

```python id="Dg2lCrv0dgqM" colab={"base_uri": "https://localhost:8080/", "height": 407} executionInfo={"status": "ok", "timestamp": 1726488434371, "user_tz": -120, "elapsed": 4199, "user": {"displayName": "Mario Negrello", "userId": "10136788594790905986"}} outputId="67f92c47-ec45-4f04-a1f1-1fb4cdb78fb1"
#Protocol 2
restore('setup')
G.v = 0*mV
G.m = 0
...
```python id="zkZX_x0teGP-" colab={"base_uri": "https://localhost:8080/", "height": 407} executionInfo={"status": "ok", "timestamp": 1726488453042, "user_tz": -120, "elapsed": 4415, "user": {"displayName": "Mario Negrello", "userId": "10136788594790905986"}} outputId="8ef81dd2-46e4-4da9-a387-3359700f7ba9"
# Exercise 4
restore('setup')
...
```python id="443ExA1HldRI" colab={"base_uri": "https://localhost:8080/", "height": 407} executionInfo={"status": "ok", "timestamp": 1726488494910, "user_tz": -120, "elapsed": 4698, "user": {"displayName": "Mario Negrello", "userId": "10136788594790905986"}} outputId="c46eee77-86dd-47ac-aeba-15c20cea0a23"
# Exercise 5
restore('setup')
...
```python id="JLM3qCcLlc4L" colab={"base_uri": "https://localhost:8080/", "height": 407} executionInfo={"status": "ok", "timestamp": 1726488509633, "user_tz": -120, "elapsed": 4826, "user": {"displayName": "Mario Negrello", "userId": "10136788594790905986"}} outputId="b8fdc658-25c3-4d38-f962-289d39272754"
# Exercise 6
restore('setup')
...
```python id="vD01mR7qin4O" colab={"base_uri": "https://localhost:8080/", "height": 407} executionInfo={"status": "ok", "timestamp": 1726488522304, "user_tz": -120, "elapsed": 5152, "user": {"displayName": "Mario Negrello", "userId": "10136788594790905986"}} outputId="22a8b85a-8132-4f54-a951-a85b88b1ab7c"
# Challenge 1
...
```python id="i2iCeUd764vZ" colab={"base_uri": "https://localhost:8080/", "height": 411} executionInfo={"status": "ok", "timestamp": 1726488564434, "user_tz": -120, "elapsed": 1973, "user": {"displayName": "Mario Negrello", "userId": "10136788594790905986"}} outputId="adddeacf-9c02-4b12-afd3-9607b4f8c5e7"
# Challenge 2:
...
```python id="AnUOOqxV2-P3" colab={"base_uri": "https://localhost:8080/", "height": 367} executionInfo={"status": "ok", "timestamp": 1662901908129, "user_tz": -120, "elapsed": 339, "user": {"displayName": "Elias Mateo Fernandez Santoro", "userId": "07472471926015090759"}} outputId="ee04a57a-f072-4a0a-9ad7-f1062049bf34"
# Final Challenge:
...
```python colab={"base_uri": "https://localhost:8080/", "height": 669} id="f3DcFueyoppk" executionInfo={"status": "ok", "timestamp": 1662901908574, "user_tz": -120, "elapsed": 448, "user": {"displayName": "Elias Mateo Fernandez Santoro", "userId": "07472471926015090759"}} outputId="ceb28c54-c8d2-43c3-9bdc-44cbc902eae2"
