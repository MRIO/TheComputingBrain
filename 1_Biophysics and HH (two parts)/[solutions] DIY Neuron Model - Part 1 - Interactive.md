...
```python colab={"base_uri": "https://localhost:8080/"} executionInfo={"elapsed": 19105, "status": "ok", "timestamp": 1773839153945, "user": {"displayName": "Mario Negrello", "userId": "10136788594790905986"}, "user_tz": -60} id="eQ_SMlDrZVjY" outputId="a9af43ee-a942-4330-fb44-74bffb3d58e8"
# install brian2

```

```python executionInfo={"elapsed": 3223, "status": "ok", "timestamp": 1773839191115, "user": {"displayName": "Mario Negrello", "userId": "10136788594790905986"}, "user_tz": -60} id="88Qmb5nEPYq6"
...
```python executionInfo={"elapsed": 31, "status": "ok", "timestamp": 1773839192898, "user": {"displayName": "Mario Negrello", "userId": "10136788594790905986"}, "user_tz": -60} id="IcG4Jl5lXFam"
#for interactive plotting

```

```python executionInfo={"elapsed": 49, "status": "ok", "timestamp": 1773839193359, "user": {"displayName": "Mario Negrello", "userId": "10136788594790905986"}, "user_tz": -60} id="YPLu-qOb4-rA"
...
```python executionInfo={"elapsed": 7, "status": "ok", "timestamp": 1773839199908, "user": {"displayName": "Mario Negrello", "userId": "10136788594790905986"}, "user_tz": -60} id="9f7btJcm9CQf"
...
```python executionInfo={"elapsed": 20, "status": "ok", "timestamp": 1773839218537, "user": {"displayName": "Mario Negrello", "userId": "10136788594790905986"}, "user_tz": -60} id="z7KoI0j3KSYO"
...
```python colab={"base_uri": "https://localhost:8080/", "height": 621, "referenced_widgets": ["ef0ab770cb4c49058e9448812f7afbb4", "972df760d0974f72a2ccf09b1a8c4978", "aef066d8783746939e8645c3a251a1ce", "dd8e8e80b70d469c9ebae47864f67acd", "36870ceda3a642b0a830b69046be5725", "f7d388d7fd304f2786b74c1957245df6", "1ddba055b02a4035a1bd39df492442ba", "580e44a2cf1c4d98ae427eb7edf27988", "5a4cee07ef65468eb04db433833ef858", "18020ef703324bfd8ad77e9af2dfcb2a", "65bce506b9da4845a7d79cc1d4433937", "5fd7b75675394e5abd86f05ffac6955a", "46b04bcfa9d1473e95f73e3e7d35125e", "f5e7f2f33f7a4b6783d6606302927284", "da10b8aa7abf4350a0faed8d81df7056", "19b98faa8f3d45e68c6ba8ad0e888636", "aa13646539dc4b0b9f77c8ef923ca6d8"]} id="6bzpmsUfl_Vr" outputId="39e94ce5-689a-4260-9b53-c2f17f2655a1" executionInfo={"status": "ok", "timestamp": 1773839221946, "user_tz": -60, "elapsed": 1891, "user": {"displayName": "Mario Negrello", "userId": "10136788594790905986"}}
#@title Interactive
...
```python colab={"background_save": true, "referenced_widgets": ["b293458dad3a46ffab82c09c7effa44a"]} id="TMqH-tDCmMtN" outputId="4393c6f2-a626-4ccf-f554-3033c23c4355"
#@title Interactive
...
```python colab={"background_save": true, "referenced_widgets": ["076a7e3afa4048c0829e7884552a3c85"]} id="DViLXA9i0Upz" outputId="e41ecfc8-7a49-4096-f937-7e72f64ef660"
# Initial Plot (change name!)
plotname="tau_sig"
plt.close(plotname)
...
```python colab={"background_save": true} id="WTO0vzMiKvae"
