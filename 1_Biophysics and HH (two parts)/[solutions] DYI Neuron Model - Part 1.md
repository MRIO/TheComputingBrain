...
```python id="88Qmb5nEPYq6" colab={"base_uri": "https://localhost:8080/"} executionInfo={"status": "ok", "timestamp": 1725895047964, "user_tz": -120, "elapsed": 22321, "user": {"displayName": "Mario Negrello", "userId": "10136788594790905986"}} outputId="037f61eb-3f83-4e77-d78e-61a1fc918427"
# install brian2
...
```python colab={"base_uri": "https://localhost:8080/", "height": 595, "referenced_widgets": ["cc8e5bc96c7d4a0db839edb06228e0ae", "7ee39d0653d448d5ac53aa9032ca79ca", "c8685b2dc2404eafa612c4af6cd193e4", "3731056444504b6fa198aaf9cc95e416", "3df0ba6983a340d0b44d7abe94f4e819", "54a813a5e56e4034a7b9ce52d5aa3f84", "b805e77e3e6a49429d3231a9fdec3065", "135606aaa27f446baf63a528c03808f5", "fa1f43e4ae894151b5e7f026a629c235", "0598ee645f7f4d1b8f6d7fa7eec051db", "2848e554849944188438375f410a840f", "7e5e121ba8bb4c5cb7d20042b1df7d47", "f8112328706445d0bcc445d911126644"]} id="v3yKjghdZfGX" executionInfo={"status": "ok", "timestamp": 1725895074289, "user_tz": -120, "elapsed": 26360, "user": {"displayName": "Mario Negrello", "userId": "10136788594790905986"}} outputId="773e9460-d71c-4fc5-9002-4a760c85c5c0"
...
```python colab={"base_uri": "https://localhost:8080/", "height": 466} id="8FuejXdS1Q4x" executionInfo={"status": "ok", "timestamp": 1725895074786, "user_tz": -120, "elapsed": 574, "user": {"displayName": "Mario Negrello", "userId": "10136788594790905986"}} outputId="03d17626-0ebd-407e-ab98-6bd8cc73021b"
...
```python id="M7HGg_xhcwys" colab={"base_uri": "https://localhost:8080/", "height": 466} executionInfo={"status": "ok", "timestamp": 1725895074787, "user_tz": -120, "elapsed": 77, "user": {"displayName": "Mario Negrello", "userId": "10136788594790905986"}} outputId="0b8342a6-76f8-4b39-a1d2-820e84babae7"
# define a function m_inf that returns the
# steady state of m gate for any value of the potential V.
...
```python colab={"base_uri": "https://localhost:8080/", "height": 466} id="IQz8yjjP__dg" executionInfo={"status": "ok", "timestamp": 1725895074788, "user_tz": -120, "elapsed": 59, "user": {"displayName": "Mario Negrello", "userId": "10136788594790905986"}} outputId="5aad9a1a-d4ff-419e-d791-8ee27f9a1c8f"
...
```python id="eGeuWokMc9mK" colab={"base_uri": "https://localhost:8080/", "height": 213} executionInfo={"status": "ok", "timestamp": 1725895075667, "user_tz": -120, "elapsed": 915, "user": {"displayName": "Mario Negrello", "userId": "10136788594790905986"}} outputId="db0e6d0c-b0ea-4f3c-ca67-4ebb5a17e1ac"
# your code
def sigmoid(v_at_half, k, V):
  return (1./(1.+np.exp((v_at_half-V)/k)))
...
```python id="XKTnH5WC8tNj" cellView="form" colab={"base_uri": "https://localhost:8080/", "height": 213} executionInfo={"status": "ok", "timestamp": 1725895076127, "user_tz": -120, "elapsed": 485, "user": {"displayName": "Mario Negrello", "userId": "10136788594790905986"}} outputId="7a71b9cb-94e7-45dc-df35-df35cbb55922"
...
```python colab={"base_uri": "https://localhost:8080/", "height": 547, "referenced_widgets": ["6c1271d9f6214b72ae2091e0b974f1f3", "f627b9802f374cc4b3b94091a74b1ac3", "d671b686495c416fa5159f8357dbc192", "81a0f0ce809e4580aa75a4a6a5b01c83", "9c12c7a39ab14515acf9e885b7a35840", "f68ca05caecf481fb97b310d446d16fa", "588c234a30014491ad991005a1f0ab62"]} id="A-8A50z4kwkl" executionInfo={"status": "ok", "timestamp": 1725895083741, "user_tz": -120, "elapsed": 7644, "user": {"displayName": "Mario Negrello", "userId": "10136788594790905986"}} outputId="2217086a-bd1f-48b6-bdf2-d26f94adf573"
...
```python id="-S7u_v53k11H" colab={"base_uri": "https://localhost:8080/", "height": 378} executionInfo={"status": "ok", "timestamp": 1725895102536, "user_tz": -120, "elapsed": 865, "user": {"displayName": "Mario Negrello", "userId": "10136788594790905986"}} outputId="6992c92b-7766-4876-cc29-d4868de5236e"
# Plot results
...
```python id="yC6rdTHY5sHe" colab={"base_uri": "https://localhost:8080/", "height": 54} executionInfo={"status": "ok", "timestamp": 1725895103125, "user_tz": -120, "elapsed": 594, "user": {"displayName": "Mario Negrello", "userId": "10136788594790905986"}} outputId="c72e04c9-11e6-4cd9-fead-fcc74d41eecc"
# your code goes here
def sigmoid(v_at_half, k, V):
  return (1./(1.+np.exp((v_at_half-V)/k)))
...
```python id="dOi-SHjpeowv" colab={"base_uri": "https://localhost:8080/"} executionInfo={"status": "ok", "timestamp": 1725895114176, "user_tz": -120, "elapsed": 11056, "user": {"displayName": "Mario Negrello", "userId": "10136788594790905986"}} outputId="52bd6e69-e3f5-4b68-d61e-4c50a9e83510"
 start_scope()
...
```python id="x9_FOyseaAYP" colab={"base_uri": "https://localhost:8080/", "height": 120} executionInfo={"status": "ok", "timestamp": 1725895114855, "user_tz": -120, "elapsed": 686, "user": {"displayName": "Mario Negrello", "userId": "10136788594790905986"}} outputId="484c5001-2430-4545-fbdf-fd9f6229de21"
# plot it
