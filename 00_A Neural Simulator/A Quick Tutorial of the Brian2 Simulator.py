...
# %% [markdown] id="aQoA0fOfIjWr" colab_type="text"
...
# %% [markdown] id="5DUVMJiRIpAx" colab_type="text"
# # Part 1: A Quick Tutorial of the Brian2 Simulator

# %% [markdown] id="URJworgssnv9" colab_type="text"
...
# %% [markdown] id="nqn7zGeRqPBP" colab_type="text"
# ---
...
# %% [markdown] id="10Jgxfv3gcTr" colab_type="text"
# ---
...
# %% [markdown] id="r8b_9kSxZmC9" colab_type="text"
...
# %% [markdown] id="6uyKczJFXGIV" colab_type="text"
...
# %% [markdown] id="wZnQOAEog-so" colab_type="text"
# ---
...
# %% id="lRdzz7EhhFTB" colab_type="code" outputId="0ff10eb5-a4f2-4f0f-dd71-370060146108" executionInfo={"status": "ok", "timestamp": 1588986113414, "user_tz": -180, "elapsed": 7047, "user": {"displayName": "Christos Strydis", "photoUrl": "https://lh3.googleusercontent.com/a-/AOh14Gi63S46dCgrA3KHL62sJZLEG5Cg67r2Yf1pTEwLLw=s64", "userId": "08542955873475941983"}} colab={"base_uri": "https://localhost:8080/", "height": 52}
# %%time

Cm = 1.0*uF/cm**2  #The membrane capacitance

# %% [markdown] id="LzS_-l_ShHdS" colab_type="text"
# ---
...
# %% id="7jrsx66khJN6" colab_type="code" outputId="7da89621-8ad6-4459-c103-1f8fcd3bc9c3" executionInfo={"status": "ok", "timestamp": 1588986113415, "user_tz": -180, "elapsed": 7016, "user": {"displayName": "Christos Strydis", "photoUrl": "https://lh3.googleusercontent.com/a-/AOh14Gi63S46dCgrA3KHL62sJZLEG5Cg67r2Yf1pTEwLLw=s64", "userId": "08542955873475941983"}} colab={"base_uri": "https://localhost:8080/", "height": 52}
# %%time
...
# %% [markdown] id="-5M6pf3ohOy2" colab_type="text"
# ---
# ## Creating a Neuron
...
# %% id="fBoawKRChPD7" colab_type="code" outputId="ec2c3c87-ffac-4c2e-854a-a4177e53660a" executionInfo={"status": "ok", "timestamp": 1588986113415, "user_tz": -180, "elapsed": 6976, "user": {"displayName": "Christos Strydis", "photoUrl": "https://lh3.googleusercontent.com/a-/AOh14Gi63S46dCgrA3KHL62sJZLEG5Cg67r2Yf1pTEwLLw=s64", "userId": "08542955873475941983"}} colab={"base_uri": "https://localhost:8080/", "height": 52}
# %%time

N_IF = 1
Neuron_IF = NeuronGroup(N_IF, eqs_IF, method = 'euler')

# %% [markdown] id="x6cxDlVUhoGV" colab_type="text"
# ---
# ## Recording
...
# %% id="BrDrFIZLhpzq" colab_type="code" outputId="bfc1e35b-5f10-48b2-890f-3f69890961a7" executionInfo={"status": "ok", "timestamp": 1588986113416, "user_tz": -180, "elapsed": 6954, "user": {"displayName": "Christos Strydis", "photoUrl": "https://lh3.googleusercontent.com/a-/AOh14Gi63S46dCgrA3KHL62sJZLEG5Cg67r2Yf1pTEwLLw=s64", "userId": "08542955873475941983"}} colab={"base_uri": "https://localhost:8080/", "height": 52}
# %%time
...
# %% [markdown] id="KuA11Xo8hsuZ" colab_type="text"
# ---
# ## Simulating a Neuron
...
# %% [markdown] id="eNvfKi6Ocm9E" colab_type="text"
...
# %% [markdown] id="JSfQaGLOhZHo" colab_type="text"
# ---
...
# %% id="t716a5fVh7Yl" colab_type="code" outputId="f707a522-4a8a-4cbf-ecbc-59c9d283f49a" executionInfo={"status": "ok", "timestamp": 1588986114764, "user_tz": -180, "elapsed": 8268, "user": {"displayName": "Christos Strydis", "photoUrl": "https://lh3.googleusercontent.com/a-/AOh14Gi63S46dCgrA3KHL62sJZLEG5Cg67r2Yf1pTEwLLw=s64", "userId": "08542955873475941983"}} colab={"base_uri": "https://localhost:8080/", "height": 423}
# %%time
...
# %% [markdown] id="IJApsU-ch6XC" colab_type="text"
...
# %% [markdown] id="hsxIWNwiqKuT" colab_type="text"
# ---
...
# %% [markdown] id="29D-NHF3Krk3" colab_type="text"
# ---
...
# %% [markdown] id="aHsxtKoHWOGv" colab_type="text"
