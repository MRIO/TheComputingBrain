...
# %% [markdown] id="8-wMVqObQ--2"
# # Project: Spiking Networks

# %% [markdown] id="pi4ydK9ORD6Q"
# ## How do spikes propagate through networks?
#
#

# %% [markdown] id="_Y_1bcH3-eeW"
...
# %% [markdown] id="hmSPB9pt4MkD"
# ## Simulating Neural Networks with Brian

# %% [markdown] id="mx5UK4Yt4SSq"
...
# %% [markdown] id="5UxEbiVFRluX"
# ## Pre-requisites

# %% [markdown] id="dvOWrxWE-kSE"
...
# %% [markdown] id="nuYOM7ZBR1IV"
# ## Learning Goals

# %% [markdown] id="I_i8tAxfR360"
...
# %% [markdown] id="8APOQsJ5S5v6"
# ## Terminology

# %% [markdown] id="AaaBr-HzS-3s"
...
# %% [markdown] id="SttVU8WY4sAg"
# ## Network with Random Inputs

# %% [markdown] id="_jB0-OpG9olq"
#
#
...
# %% [markdown] id="pqx6jRSz3snF"
# ## LIF network with Poisson inputs

# %% [markdown] id="cuUk5istPYuZ"
...
# %% [markdown] id="-0I16Jm-BdlT"
# ### Inspecting Outputs

# %% [markdown] id="FcZE4ftgzC2N"
...
# %% [markdown] id="TamLew49AmIW"
# ## Measuring Spiking Activity

# %% [markdown] id="tLp0XtoX7QIx"
...
# %% [markdown] id="y1kno3ap0mkc" solution="shown" solution_first=true
# ### Firing Rates

# %% [markdown] id="w2HuTxwNzC2Q"
# #### Exercise
#
# ---
#
...
# %% [markdown] id="HgcrV1BZHk1U"
# ### Visualizing Network Activity

# %% [markdown] id="5S_rNwghFRTn"
...
# %% [markdown] id="QcK91ZSxO7xa"
# #### Questions

# %% [markdown] id="a6iOGLieGWR9"
# ---
...
# %% [markdown] id="q9I7KqVdhpxh"
# #### Answers

# %% [markdown] id="G_rcty09hs9b"
# **Question 1.**
#
...
# %% [markdown] id="0i1KS6v92hc1"
# ## LIF with Periodic Input

# %% [markdown] id="k32wqR71zJ6E"
...
# %% [markdown] id="95qM_h9J5CXs"
# # Part II. Balanced Networks
#
#
#

# %% [markdown] id="hcmUCtk0T4hi"
# ## Phase transitions
#
#

# %% [markdown] id="MI2erVpb5rk-"
...
# %% [markdown] id="C4yEkJU3uIax"
# ## Recipe for a balanced network:

# %% [markdown] id="PIW9BgT0Gzg_"
...
# %% [markdown] id="WjixYZ2CzPiO"
# ### Voltage Synapses

# %% [markdown] id="C1BHpXHL-LNz"
...
# %% [markdown] id="9ikdf2CizC2h"
# ### Connect Neurons

# %% [markdown] id="nfv1qhozzC2h"
...
# %% [markdown] id="scfUsCmyzC2i"
# ### Connect Monitors

# %% [markdown] id="ABPfYIRFzC2i"
...
plt.plot(rate_monitor.t/ms, rate_monitor.rate/Hz, color='xkcd:coral')
plt.xlabel('time (ms)')
plt.ylabel('A(t) (Hz)')
tight_layout()

# %% [markdown] id="-o0D1n127OC0"
# ## Emergence of synchronisation

# %% [markdown] id="3Yn69hXi9yA5"
...
# %% [markdown] id="mFqr-uLOzC2l"
# ### Your Code

# %% id="sguBj-djzC2l"
### Your Network Here

# %% [markdown] heading_collapsed=true id="XOsaLRiDzC2l"
# ### Our Code

# %% hidden=true id="R7dqKx59zlwA"
start_scope()
...
# %% hidden=true id="WKv_Nu6szltl"
sim_time = 250*ms

# simulate for this duration
run(sim_time)

# %% hidden=true id="_azFNizOzlrk"
# plot it
...
# %% [markdown] id="KUPkqFbr71rZ"
# ## Disable recurrent feedback
#
#

# %% [markdown] id="sMdw5PwCiACA"
#
#
# ---
#
...
# %% [markdown] id="ixHHhTwKM0cP"
# ### Your Code

# %% id="r1rzjW3YMz63"
### your code

# %% [markdown] id="XQIURlq6MygR"
# ### Solution
