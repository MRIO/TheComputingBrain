...
```python id="31d45806" executionInfo={"status": "error", "timestamp": 1696324212593, "user_tz": -120, "elapsed": 17, "user": {"displayName": "Mario Negrello", "userId": "10136788594790905986"}} outputId="dd855738-39a3-49d9-bdd9-7c7c9d58dab7" colab={"base_uri": "https://localhost:8080/", "height": 159}
#@title ### Your Solution
...
```python id="99345006" cellView="form"
#@title ### Exercise
