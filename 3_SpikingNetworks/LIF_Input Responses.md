...
NOTEBOOK_REQUIREMENTS = [('ipywidgets', 'ipywidgets'), ('matplotlib', 'matplotlib'), ('numpy', 'numpy'), ('scipy', 'scipy')]
...
```python id="bQ1Ue4PZd6ur" executionInfo={"status": "ok", "timestamp": 1727443279616, "user_tz": -120, "elapsed": 2992, "user": {"displayName": "Stefan Lip", "userId": "03887089210646311038"}}
...
```python id="0FILOnWKdvZg" executionInfo={"status": "ok", "timestamp": 1727443279616, "user_tz": -120, "elapsed": 4, "user": {"displayName": "Stefan Lip", "userId": "03887089210646311038"}}
...
```python id="RG0ycWUDdYSg" executionInfo={"status": "ok", "timestamp": 1727443279616, "user_tz": -120, "elapsed": 4, "user": {"displayName": "Stefan Lip", "userId": "03887089210646311038"}}
 p = default_pars()
...
```python id="Hhk7e-QreVSh" executionInfo={"status": "ok", "timestamp": 1727443279616, "user_tz": -120, "elapsed": 3, "user": {"displayName": "Stefan Lip", "userId": "03887089210646311038"}}
def run_LIF(pars, I):
    '''
...
```python colab={"base_uri": "https://localhost:8080/", "height": 388} executionInfo={"elapsed": 1595, "status": "ok", "timestamp": 1727443281208, "user": {"displayName": "Stefan Lip", "userId": "03887089210646311038"}, "user_tz": -120} id="6wBTrRy4ea19" outputId="e6f1509d-4e06-4040-df8f-5f2cf67158f8"
pars = default_pars()
v, rec_spikes = run_LIF(pars, I = 250.)
...
```python colab={"base_uri": "https://localhost:8080/", "height": 420, "referenced_widgets": ["921158e1367644bc83da0f22d1aead6c", "75b3641b8ec54a069f8903443d27b1c8", "cfd00dbc218d4d75a758ff74fff962e1", "2e05167c5a284b0ca01043ebe6db3eb0", "e741b9a7066c4fb29dec087e5fd1877a", "36f4fe4f80354525981e62b45acc9ee7", "21bf2940474c44f0859ab7605085cc8e"]} executionInfo={"elapsed": 1007, "status": "ok", "timestamp": 1727443282210, "user": {"displayName": "Stefan Lip", "userId": "03887089210646311038"}, "user_tz": -120} id="aFqJZUNGotb5" outputId="641a3681-1fd2-4c89-a08e-356055db4a42"
...
```python id="qBWHhnNnehYX" executionInfo={"status": "ok", "timestamp": 1727443282210, "user_tz": -120, "elapsed": 2, "user": {"displayName": "Stefan Lip", "userId": "03887089210646311038"}}
...
```python colab={"base_uri": "https://localhost:8080/", "height": 388} executionInfo={"elapsed": 2101, "status": "ok", "timestamp": 1727443284309, "user": {"displayName": "Stefan Lip", "userId": "03887089210646311038"}, "user_tz": -120} id="vOoaaocSelHW" outputId="e4941e95-f5a9-4d65-c5df-c766105ded82"
pars = default_pars(dt=0.1)
sig_ou = .5
...
```python colab={"base_uri": "https://localhost:8080/", "height": 405} executionInfo={"elapsed": 815, "status": "ok", "timestamp": 1727443285122, "user": {"displayName": "Stefan Lip", "userId": "03887089210646311038"}, "user_tz": -120} id="Gp-7ip0yfHHi" outputId="9708dcf7-d2c8-41fd-8d79-425ad371b007"
...
```python id="C-ejnNfKdVSF" executionInfo={"status": "ok", "timestamp": 1727443289149, "user_tz": -120, "elapsed": 4029, "user": {"displayName": "Stefan Lip", "userId": "03887089210646311038"}}
...
```python colab={"base_uri": "https://localhost:8080/", "height": 672} executionInfo={"elapsed": 5136, "status": "ok", "timestamp": 1727443294281, "user": {"displayName": "Stefan Lip", "userId": "03887089210646311038"}, "user_tz": -120} id="8i4WJLm7SSLQ" outputId="2c946f80-ebd2-448d-b36c-ed39f121a958"
plt.figure()
...
```python colab={"base_uri": "https://localhost:8080/", "height": 405, "referenced_widgets": ["0f57fefe6f474fa0853e109f7fca248b", "a41065ddf3ac4e01ad31c8f5fd1dcb55", "50d9729059ba4fb2a93a2a3b4a4b2be1", "abbdce16a164488494c091a6b0617fd3", "314be178410e49d198629b9683776c7e", "29449f13130b435db46037f4f9d42c24", "5eb6b360f11a49fdaa75dc716b8470ff"]} executionInfo={"elapsed": 944, "status": "ok", "timestamp": 1727443295220, "user": {"displayName": "Stefan Lip", "userId": "03887089210646311038"}, "user_tz": -120} id="Je-vmMHkmU_0" outputId="429c49bb-b933-4d27-a4a5-dc725c0792f5"
def response_regularity(sigma=0):
  ...
  plt.plot(pars['range_t'], I_total, 'k')
  plt.xlabel('Time (ms)')
  plt.ylabel('Isyn (pA)');
  plt.xlim(100,200)
...
```python id="vn-Nt8GzfIWP" executionInfo={"status": "ok", "timestamp": 1727443295220, "user_tz": -120, "elapsed": 2, "user": {"displayName": "Stefan Lip", "userId": "03887089210646311038"}}
...
```python colab={"base_uri": "https://localhost:8080/", "height": 388} executionInfo={"elapsed": 1251, "status": "ok", "timestamp": 1727443296469, "user": {"displayName": "Stefan Lip", "userId": "03887089210646311038"}, "user_tz": -120} id="ob2ihP2KfPOr" outputId="d449b170-e37f-4707-86f6-682b5a9861b7"
...
```python colab={"base_uri": "https://localhost:8080/", "height": 388} executionInfo={"elapsed": 800, "status": "ok", "timestamp": 1727443297268, "user": {"displayName": "Stefan Lip", "userId": "03887089210646311038"}, "user_tz": -120} id="4CbNDDUzfQaa" outputId="2d2e516b-9962-4cfb-a10c-38da8b103dba"
...
```python id="sGeDeA4-fWI6" executionInfo={"status": "ok", "timestamp": 1727443297268, "user_tz": -120, "elapsed": 4, "user": {"displayName": "Stefan Lip", "userId": "03887089210646311038"}}
...
```python colab={"base_uri": "https://localhost:8080/", "height": 388} executionInfo={"elapsed": 1168, "status": "ok", "timestamp": 1727443298433, "user": {"displayName": "Stefan Lip", "userId": "03887089210646311038"}, "user_tz": -120} id="NSM-drLwfhWs" outputId="8fe8ba9b-2d4a-4706-af14-44a45d39f0ef"
pars = default_pars()
...
```python colab={"base_uri": "https://localhost:8080/", "height": 406} executionInfo={"elapsed": 6856, "status": "ok", "timestamp": 1727443305287, "user": {"displayName": "Stefan Lip", "userId": "03887089210646311038"}, "user_tz": -120} id="oMqaksMrfl1z" outputId="b0ef0dfa-16c7-48aa-c8d8-94381659a44d"
pars = default_pars()
pars['T'] = 1000.
...
```python id="ct0irfEwfpgJ" executionInfo={"status": "ok", "timestamp": 1727443305287, "user_tz": -120, "elapsed": 2, "user": {"displayName": "Stefan Lip", "userId": "03887089210646311038"}}
...
```python colab={"base_uri": "https://localhost:8080/", "height": 325} executionInfo={"elapsed": 3453, "status": "ok", "timestamp": 1727443308738, "user": {"displayName": "Stefan Lip", "userId": "03887089210646311038"}, "user_tz": -120} id="V6qQavs3ftYT" outputId="cd244992-a5b6-4dc4-ce73-9272d30292b1"
pars = default_pars()
pars['gE_bar']    = 1.2 #[nS]
pars['VE']        = 0. #[mV]
pars['tau_syn_E'] = 5. #[ms]
...
```python colab={"base_uri": "https://localhost:8080/", "height": 528, "referenced_widgets": ["37325d76f7cb4fb3bae890633bc72d37", "3a035c1637ec481ba48132929c8eae4b", "04876ba597984b7c9920319ac57aa7e0", "a41bf9f19f574a9ea4ecdc8d43739c93", "a131ef5e286c43a888eccf8547fe8d52", "6f85539c971c46009b916df6171ed835", "d7265641b6cb4a10a430bbaa402647cd", "a88a1900d2a748f8bf6be08c015f6cca", "6b66ab034acf4751b84367dff6861d59", "bf11fe1681b34259b2b9b6a89ddb128a"]} executionInfo={"elapsed": 1889, "status": "ok", "timestamp": 1727443310623, "user": {"displayName": "Stefan Lip", "userId": "03887089210646311038"}, "user_tz": -120} id="wwCQTx3w1RUq" outputId="138464ef-1584-4de1-f6d3-f233cbfc0ccb"
...
```python id="4H5mDLYK9KBo" executionInfo={"status": "ok", "timestamp": 1727443330687, "user_tz": -120, "elapsed": 20066, "user": {"displayName": "Stefan Lip", "userId": "03887089210646311038"}}
...
```python colab={"base_uri": "https://localhost:8080/", "height": 795} executionInfo={"elapsed": 2180, "status": "ok", "timestamp": 1727443332858, "user": {"displayName": "Stefan Lip", "userId": "03887089210646311038"}, "user_tz": -120} id="KKL0Bo8lALfL" outputId="cde32d74-6b7d-488f-ea17-7b0ce7d85191"
plt.figure()
