...
## Requirements
- Understanding, the electrical potential across membrane is due to differences in chemical concentration.
- The membrane potential is altered by flux of ions across the membrane via ion channels.
 
### The landmarks in the road map:

1. Membrane permeability to different ions varies as a function of the membrane potential (active channels).
2. Positive feedback creates an accelerating rise of positive currents due to sodium channels.
3. High membrane potential actives potassium channels (a negative feedback).
4. Spikes are due to the different time scales of ion permeability.

# Key Terms


- **Permeability**. How easy it is for an ion to cross the membrane. Plastic is 'impermeable to water'. Expressed as a proportionality. It is proportional to the number of open channels on the membrane for an ion. Commonly expressed as relative permeability of the ion channels compared to one another.
...
```
    ...
    WARNING    'v' is an internal variable of group 'neurongroup', but also exists in the run namespace with the value array([-120., -119., -118., ...,   77.,   78.,   79.]). The internal variable will be used. [brian2.groups.group.Group.resolve.resolution_conflict]
...
```
    ...
    WARNING    'h' is an internal variable of group 'neurongroup', but also exists in the run namespace with the value array([0.        , 0.00318019, 0.00635009, ..., 0.08102202, 0.08102201,
           0.081022  ]). The internal variable will be used. [brian2.groups.group.Group.resolve.resolution_conflict]
    WARNING    'm' is an internal variable of group 'neurongroup', but also exists in the run namespace with the value array([0.00000000e+00, 2.08397022e-04, 4.05516726e-04, ...,
           3.64576441e-01, 3.64576441e-01, 3.64576441e-01]). The internal variable will be used. [brian2.groups.group.Group.resolve.resolution_conflict]
...
```
    ...
    WARNING    'h' is an internal variable of group 'neurongroup', but also exists in the run namespace with the value array([1.00000000e+00, 9.99949136e-01, 9.99898279e-01, ...,
           6.21828137e-06, 6.21831145e-06, 6.21834153e-06]). The internal variable will be used. [brian2.groups.group.Group.resolve.resolution_conflict]
    WARNING    'm' is an internal variable of group 'neurongroup', but also exists in the run namespace with the value array([0.00000000e+00, 1.83762555e-04, 3.66544751e-04, ...,
           9.97992019e-01, 9.97992012e-01, 9.97992004e-01]). The internal variable will be used. [brian2.groups.group.Group.resolve.resolution_conflict]
    WARNING    'v' is an internal variable of group 'neurongroup', but also exists in the run namespace with the value array([-70.        , -70.        , -70.        , ...,  15.87555789,
            15.87552386,  15.87548983]). The internal variable will be used. [brian2.groups.group.Group.resolve.resolution_conflict]
