...
# %% [markdown] id="ltdne-RQzfhc"
# # Matching Law and the Perceptron

# %% [markdown] id="tVqR02zBvNbF"
# ## Introduction

# %% [markdown] id="zRzmITZSeC2x"
...
# %% [markdown] id="-ZNDkZZovUqM"
# ### The Matching Law

# %% [markdown] id="80KzvjHmd18C"
...
# %% [markdown] id="L6iFQnvyyCrT"
# # The Perceptron and the Matching Law

# %% [markdown] id="hMpifNM3yIqH"
...
# %% [markdown] id="E0h3Z4gGy5zu"
# ### Coding Examples: Perceptron and Matching

# %% [markdown] id="SS8MfWd40XYk"
...
# %% [markdown] id="xh2emSKqFiUR"
# **Plot the weights over time**

# %% colab={"base_uri": "https://localhost:8080/", "height": 468} id="irKLR2iH-W1y" executionInfo={"status": "ok", "timestamp": 1717484399981, "user_tz": -120, "elapsed": 790, "user": {"displayName": "Mario Negrello", "userId": "10136788594790905986"}} outputId="4e31eff4-90a5-4b22-a85c-111a414051a6"
plt.figure()
plt.plot(history_w.T)
plt.xlabel("Epoch of Training")
plt.ylabel("Weights")

# %% [markdown] id="h8SqQvB3Di54"
