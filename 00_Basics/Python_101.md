...
```python id="jRnUqyqA370O" executionInfo={"status": "ok", "timestamp": 1756799187737, "user_tz": -120, "elapsed": 52, "user": {"displayName": "Mario Negrello", "userId": "10136788594790905986"}}
a = 5
```
...
```python id="WZE3max74HqR" colab={"base_uri": "https://localhost:8080/"} executionInfo={"status": "ok", "timestamp": 1756799187746, "user_tz": -120, "elapsed": 3, "user": {"displayName": "Mario Negrello", "userId": "10136788594790905986"}} outputId="8e49f72b-4ba7-44f0-99c9-1e5518c6a38d"
print(a)
